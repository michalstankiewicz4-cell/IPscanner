(function () {
  ...
  var baseDictionaries = {
    en: {
      ...
      toolText_console: "Quick ping/traceroute commands and diagnostic macros.",
      toolText_wifi_detector: "Network list, profiles, and WLAN parameter details.",
      toolText_wifi_radar: "Signal-strength radar and local network placement.",
      toolText_bt_detector: "BLE and classic BT scan with basic telemetry.",
      toolText_gnss: "NMEA preview: satellites, fix type, position, and HDOP.",
      toolText_lte: "Modem AT snapshot: RSRP, RSRQ, SINR, band, and operator.",
      toolText_sniffer: "Overview of active TCP/UDP connections and process mapping.",
      toolText_imgmeta: "EXIF/XMP/IPTC parser and image container inspection.",
      toolText_phone_lookup: "Phone number data aggregation and API sources.",
      toolText_ai_assistant: "Prompt presets and security analysis via multi-provider AI.",
      toolText_scan_watch: "Heuristic detection of suspicious scans based on netstat.",
      toolText_macro: "Store and run predefined command sequences.",
      toolText_speed: "Link throughput and latency test panel.",
      toolText_proto: "Experimental sandbox for new UI modules.",
    ...
    pl: {
      ...
      toolText_console: "Szybkie komendy ping/traceroute i makra diagnostyczne.",
      toolText_wifi_detector: "Lista sieci, profile i szczegóły parametrów WLAN.",
      toolText_wifi_radar: "Radar siły sygnału i rozmieszczenia sieci lokalnych.",
      toolText_bt_detector: "Skan BLE i klasycznych urządzeń BT z podstawową telemetrią.",
      toolText_gnss: "Podgląd NMEA: satelity, typ fixa, pozycja i HDOP.",
      toolText_lte: "Migawka AT modemu: RSRP, RSRQ, SINR, pasmo i operator.",
      toolText_sniffer: "Przegląd aktywnych połączeń TCP/UDP i mapowania procesów.",
      toolText_imgmeta: "Parser EXIF/XMP/IPTC i inspekcja kontenera plików obrazu.",
      toolText_phone_lookup: "Agregacja danych numeru telefonu i źródeł API.",
      toolText_ai_assistant: "Presety promptów i analiza bezpieczeństwa przez multi-provider AI.",
      toolText_scan_watch: "Heurystyczne wykrywanie podejrzanych skanów na podstawie netstat.",
      toolText_macro: "Przechowywanie i uruchamianie gotowych sekwencji komend.",
      toolText_speed: "Panel testów przepustowości i opóźnienia łącza.",
      toolText_proto: "Eksperymentalna przestrzeń testowa dla nowych modułów UI.",
