...
window.LANG_PL = {
  ...
  btnConsole:'⌨ Terminal', btnMacro:'📁 Makro', btnSpeed:'📶 Prędkość', btnProto:'🧩 Prototyp', btnTopology:'🕸 Topologia', btnWifiRadar:'📍 WiFi Radar',
  ...
  extractorLabel:'🔎 IP extractor', extractorAdd:'[add IP]', extractorPlaceholder:'example.com\nsub.example.com',
  ...
  filterShow:'Pokaż:', filterAll:'Wszystkie', filterFavorites:'★ Ulubione', filterActive:'Aktywne', filterAnomaly:'Pośrednie', filterDead:'Martwe',
  ...
  extractorDesktopOnly:'IP extractor działa tylko w wersji desktopowej (Tauri).',
  extractorEmpty:'Wpisz co najmniej jedną domenę lub adres IP.',
  extractorResolving:(n)=>`Rozwiązuję ${n} domen…`,
  extractorDone:(a,f)=>`Dodano lub zaktualizowano ${a} adresów IP${f ? `, błędów: ${f}` : ''}.`,
  ...
  dlgDefaults:'Domyślne wartości skanowania:', dlgIpScanningLegend:'Skanowanie IP', dlgPortModeLegend:'Zachowanie skanowania portów', dlgDefaultThreads:'Równoległe połączenia (limit):', dlgDefaultDelay:'Opóźnienie między adresami IP (ms):', dlgDefaultDelayPerPort:'Opóźnienie między portami (ms):', dlgDefaultBatchSize:'Rozmiar partii portów:', dlgPortModeParallel:'Równolegle (przepustowość)', dlgPortModeSequential:'Sekwencyjnie (dyskretniej)',
  tipThreads:'Globalny limit równoległych prób połączeń podczas skanowania (2–64). Wyższa wartość = szybciej, ale większe obciążenie sieci.',
  tipIpDelay:'Przerwa (ms) między kolejnymi adresami IP. 0 = brak opóźnienia.',
  tipBatchSize:'Liczba portów przetwarzanych w jednej partii w trybie równoległym (10–500). Wpływa na rytm pracy i aktualizacji UI, nie na globalny limit połączeń.',
  ...
  menuEdit:'Edycja',
  cmdWinTitle:'Konsola', cmdMenuFile:'Plik', cmdSaveLogs:'💾 Zapisz logi...',
  ...
  customizeGlobe:'🌍 Glob (Mapa świata)', customizeConsole:'⌨ Terminal',
