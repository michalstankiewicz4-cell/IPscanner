...
window.LANG_EN = {
  ...
  btnConsole:'⌨ Terminal', btnMacro:'📁 Macro', btnSpeed:'📶 Speed', btnProto:'🧩 Prototype', btnTopology:'🕸 Topology', btnWifiRadar:'📍 WiFi Radar',
  ...
  filterShow:'Show:', filterAll:'All', filterFavorites:'★ Favorites', filterActive:'Active', filterAnomaly:'Intermediate', filterDead:'Dead',
  ...
  extractorDesktopOnly:'IP extractor works only in the desktop (Tauri) build.',
  extractorEmpty:'Enter at least one domain or IP address.',
  extractorResolving:(n)=>`Resolving ${n} domain(s)...`,
  extractorDone:(a,f)=>`Added or updated ${a} IP address(es)${f ? `, failed: ${f}` : ''}.`,
  ...
  ctxCopyIp:'Copy IP Address', ctxCopyPorts:'Copy Ports', ctxHostname:'Hostname (reverse DNS)', ctxKnock:'Port Knock', ctxScanAllPorts:'Scan this IP (all ports)',
  ...
  dlgDefaults:'Default Scan Values:', dlgIpScanningLegend:'IP scanning', dlgPortModeLegend:'Port scan behavior', dlgDefaultThreads:'Parallel connections (limit):', dlgDefaultDelay:'Delay between IP addresses (ms):', dlgDefaultDelayPerPort:'Delay between ports (ms):', dlgDefaultBatchSize:'Port batch size:', dlgPortModeParallel:'Parallel (throughput)', dlgPortModeSequential:'Sequential (stealthier)',
  tipThreads:'Global limit of concurrent connection probes during scan (2–64). Higher value = faster scan, but higher network load.',
  tipIpDelay:'Delay (ms) between consecutive IP addresses. 0 = no delay.',
  tipBatchSize:'Number of ports processed per batch in parallel mode (10–500). Affects pacing and UI update cadence, not the global connection limit.',
  ...
  btnTraceSave:'Import',
  menuEdit:'Edit',
  cmdWinTitle:'Console', cmdMenuFile:'File', cmdSaveLogs:'💾 Save logs...',
  ...
  customizeGlobe:'🌍 Globe (World Map)', customizeConsole:'⌨ Terminal',
