(function () {
  ...
  var baseDictionaries = {
    en: {
      ...
      tipActionShowUnfinishedTools: "Show/hide unfinished tools (Topology, Globe) in the Tools menu and LSB.",
    ...
    pl: {
      ...
      tipActionShowUnfinishedTools: "Pokazuje/ukrywa niedokonczone narzedzia (Topology, Globe) w menu Tools i LSB.",
