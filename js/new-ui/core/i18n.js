(function () {
  ...
  var baseDictionaries = {
    en: {
      ...
      toolText_scan_defaults: "Default scanner configuration for timeouts, retries, and concurrency.",
      toolText_import_tool: "Import, list, and remove tools/extensions from JSON manifest.",
      defaultsPanelTitle: "Default Scan Values",
      defaultsPanelNote: "Configure baseline scanning parameters used when starting a new scan session.",
      defaultsTimeoutLabel: "Host timeout (ms)",
      defaultsRetriesLabel: "Retry attempts",
      defaultsConcurrencyLabel: "Max concurrent probes",
      defaultsPortProfileLabel: "Default port profile",
      ...
      resultsIpHeaderIpAddress: "IP Address",
      ...
      blurIpSoonButtonTitle: "Blur IP - soon",
    ...
    pl: {
      ...
      toolText_scan_defaults: "Domyslna konfiguracja skanera dla timeoutow, prob ponowienia i wspolbieznosci.",
      ...
      defaultsPanelNote: "Skonfiguruj bazowe parametry skanowania uzywane przy nowej sesji.",
      defaultsTimeoutLabel: "Timeout hosta (ms)",
      defaultsRetriesLabel: "Liczba ponowien",
      defaultsConcurrencyLabel: "Maks. rownoleglych prob",
      defaultsPortProfileLabel: "Domyslny profil portow",
      ...
      blurIpSoonButtonTitle: "Rozmycie IP - wkrotce",
