(function () {
  ...
  var baseDictionaries = {
    en: {
      ...
      scannerModePorts: "Ports",
      scannerModeIcmp: "ICMP",
      scannerModeIcmpNote: "ICMP pings every host in the range - no ports needed.",
      scannerFrom: "From",
      scannerTo: "To",
      scannerPorts: "Ports",
      scannerStart: "Start",
      ...
      rightTabConfig: "Config",
      configGroupProtocol: "Protocol",
      configProtocolTcp: "TCP Connect",
      ...
      statusIcmpNotImplemented: "ICMP scanning is not implemented yet",
      statusTcpSynNotImplemented: "TCP SYN scanning is not implemented yet",
      statusUdpNotImplementedNote: "UDP scanning not implemented yet, TCP ports only",
    ...
    pl: {
      ...
      scannerRangeModeCidr: "CIDR",
      scannerModePorts: "Porty",
      scannerModeIcmp: "ICMP",
      scannerModeIcmpNote: "ICMP pinguje kazdego hosta w zakresie - porty nie sa potrzebne.",
      scannerFrom: "Od",
      scannerTo: "Do",
      scannerPorts: "Porty",
      scannerStart: "Start",
      ...
      statusIcmpNotImplemented: "Skanowanie ICMP nie jest jeszcze zaimplementowane",
      statusTcpSynNotImplemented: "Skanowanie TCP SYN nie jest jeszcze zaimplementowane",
      statusUdpNotImplementedNote: "Skanowanie UDP niezaimplementowane, tylko porty TCP",
