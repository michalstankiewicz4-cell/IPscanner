(function () {
  ...
  var baseDictionaries = {
    en: {
      ...
      importToolSubtitle: "Install addons from the GitHub catalog or load a manifest from a local file.",
      ...
      toolText_lorem_ipsum: "Placeholder tool with static filler text.",
      assistant: "Assistant",
      ...
      statusUnfinishedToolsOn: "Unfinished tools shown",
      statusUnfinishedToolsOff: "Unfinished tools hidden",
      ...
      generalUiSwitchLabel: "UI",
      generalUiSwitchDefault: "Default",
      generalUiSwitchTest: "Test",
      ...
      generalRememberShowUnfinishedTools: "Remember \"Show unfinished tools\" state",
    ...
    pl: {
      ...
      importToolSubtitle: "Instaluj dodatki z katalogu GitHub albo wczytaj manifest z pliku lokalnego.",
      ...
      toolText_lorem_ipsum: "Narzędzie placeholder ze statycznym tekstem wypełniającym.",
      assistant: "Asystent",
      ...
      statusUnfinishedToolsOn: "Pokazano niedokonczone narzedzia",
      statusUnfinishedToolsOff: "Ukryto niedokonczone narzedzia",
      ...
      generalUiSwitchLabel: "UI",
      generalUiSwitchDefault: "Domyslne",
      generalUiSwitchTest: "Testowe",
      ...
      generalRememberShowUnfinishedTools: "Pamietaj stan \"Show unfinished tools\"",
