(function () {
      ...
      function applyStaticTranslations() {
        ...
        // RS's "Lorem Ipsum" tab button is generated by tab-registry.js's
        // renderSectionTabs() now (tabLabel_lorem_ipsum), not this id.
      ...
      function refreshLanguageUi() {
        ...
        // RS's built-in tab labels are generated (see index.html's
        // .v1-right-tabs comment) - applyStaticTranslations() has no ids
        // to re-translate there anymore, so update them in place instead
        // (not renderSectionTabs(), which would reset open/active state).
