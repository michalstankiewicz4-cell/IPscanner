(function () {
      ...
      // tool refs (activityScannerBtn/activityTopologyBtn/activityGlobeBtn,
      // toolsMenuIpScanner/Topology/Globe, ipLibrary* labels,
      // resultNavIp/IpLibrary/Presets). Not split line-by-line here (too
      // fine-grained to bracket cleanly without restructuring); grouping by
      // shell vs tool is future work once this file gets its own dedicated
      // pass.
      function applyStaticTranslations() {
        ...
        // LS's tool-tab buttons and RS's "Lorem Ipsum" tab button are
        // generated by tab-registry.js's renderSectionTabs() now (ipScanner/
        // ipLibraryTabTitle/resultsSidebarTitle/toolTitle_lorem_ipsum/
        // tabLabel_shellcraft_library), not id-based lookups here.
        // lorem-ipsum (LS+RS), ip-library's LS panel (title/buttons/labels/
        // placeholder), and results-ip's LS nav list are all generated by
        ...
        // lookups+usages that used to live here (v1LoremIpsumLsHeading/
        // RsHeading, v1IpLibraryPanelTitle/UpdateBtn/LoadBtn/ClearBtn/
        // TopRangesLabel/CountryCodes placeholder, v1ResultNavIp/
        // IpLibrary/Presets) are gone - nothing left to re-translate here.
        // CS's 13 built-in tab titles (results-ip/ip-library/presets/
        // general/import-tool/language-manager/about/license/lorem-ipsum/
        // topology/globe/versions/shellcraft) are generated by
        // tab-registry.js's renderSectionTabs()/retranslateSectionTabs()
        // now, not these id-based lookups.
      ...
      try {
        if (localStorage.getItem("netrecon_show_unfinished_tools") === "1") {
          ["#v1ActivityLoremIpsum", "#v1ActivityTopology", "#v1ActivityGlobe", ".v1-menu-dd-item[data-tool=\"lorem-ipsum\"]", ".v1-menu-dd-item[data-tool=\"topology\"]", ".v1-menu-dd-item[data-tool=\"globe\"]", ".v1-menu-dd-item[data-menu-action=\"countries\"]", "[data-general-ui-switch]", "#v1ConfigProtocolTcpSynRow"].forEach(function (selector) {
