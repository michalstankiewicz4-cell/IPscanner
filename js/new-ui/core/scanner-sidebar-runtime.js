(function () {
  function createScannerSidebarRuntime(deps) {
    ...
    function applyStaticTranslations() {
      ...
      // yet, so this just handles labels/translations. The tab strip
      // button itself is generated by tab-registry.js's renderSectionTabs()
      // now (tabLabel_config), not this id-based lookup.
      var configProtocolTitle = document.getElementById("v1ConfigProtocolTitle");
      var configProtocolTcpEnabledLabel = document.getElementById("v1ConfigProtocolTcpEnabledLabel");
      ...
      var configProtocolIcmpLabel = document.getElementById("v1ConfigProtocolIcmpLabel");
      ...
      if (configProtocolTcpEnabledLabel) configProtocolTcpEnabledLabel.textContent = t("configProtocolTcpEnabled");
      ...
      if (configProtocolIcmpLabel) configProtocolIcmpLabel.textContent = t("scannerModeIcmp");
